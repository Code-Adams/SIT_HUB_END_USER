...
import com.sakshmbhat.sit_hub_end_user.nav_drawer.clubsOfSIT.ClubsOfSitActivity;
import com.sakshmbhat.sit_hub_end_user.nav_drawer.developerReference.DeveloperReferenceActivity;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId())
        {
            ...
            case R.id.navigation_developer:
                ...
                break;
            case R.id.navigation_clubs_of_sit:
                startActivity(new Intent(MainActivity.this, ClubsOfSitActivity.class));
                break;
        }
